...
namespace GymManager.Web.Controllers
{
    public class MembershipRenewalController : Controller
    {
        ...
        public MembershipRenewalController(IMembersAppServices membersAppServices, IMembershipTypeAppService membershipTypeAppService)
        {
        ...
        public async Task<IActionResult> Edit (MembershipRenewalViewModel membershipRenewalModel)
        {
            ...
            await _membersAppServices.EditMemberAsync (memberToUpdate);
